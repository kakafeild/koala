...
import com.mengke.koala.client.utility.PromptImpl;
...
public class InterpreterPresenterImpl extends FileBasedMiniAppPresenterImpl implements InterpreterPresenter {
  ...
  public native void eval(String snippet) /*-{
		var javaThis = this;
		$wnd.p = function(s) {
			return javaThis.@com.mengke.koala.client.interpreter.InterpreterPresenterImpl::print(Ljava/lang/String;)(s);
		}
		eval(snippet);
  }-*/;
